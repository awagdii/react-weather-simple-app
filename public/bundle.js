	...
	var Nav = React.createClass({
	  ...
	  render: function render() {
	    return React.createElement(
	      ...
	      React.createElement(
	        IndexLink,
	        { to: '/', activeClassName: 'active', activeStyle: { fontWeight: 'bold', fontSize: 12 } },
	        'Get Weather'
	      ),
	      React.createElement(
	        Link,
	        { to: '/about', activeClassName: 'active', activeStyle: { fontWeight: 'bold', fontSize: 12 } },
	        'About'
	      ),
	      React.createElement(
	        Link,
	        { to: '/examples', activeClassName: 'active', activeStyle: { fontWeight: 'bold', fontSize: 12 } },
	        'Examples'
	      )
	    );
	  }
...
/***/ function(module, exports, __webpack_require__) {
	...
	var API_URL = 'http://api.openweathermap.org/data/2.5/weather?units=metric&appid=b1b15e88fa797225412429c1c50c122a1&apikey=9e530ba10dd0627ef2f34e597c28a094';
